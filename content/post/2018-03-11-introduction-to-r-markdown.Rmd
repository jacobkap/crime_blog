...
If you'd like to follow along with the actual Markdown file, here is a [link](https://raw.githubusercontent.com/jacobkap/crime_blog/master/content/post/2018-03-11-introduction-to-r-markdown.Rmd) to that. And here is a [link to the images included](https://github.com/jacobkap/crime_blog/tree/master/static/img/markdown_images) in this post - you'll need those images to fully run the Markdown file (or you can delete the references to them.)
...
![Note the figure caption is in the chunk options](figure_caption.PNG)
